...
# Its mean value of coin 
c1 = False
c2 = False
c5 = False

# Variable for upgrade level every time when you rechieve 10 coin
to_upgrade_speed = 10
to_upgrade_zero = 0
...
while True:      
    ...
    # Write algorithm for every value, to make them more rare
    if n == 5 :
        c1 = True
        c5 = False
        c2 = False
    ...
    # All logic when you recieve 1,2,5 value coin
    if c1 :
    ...
    #if count of coin already enough to upgrade
    if to_upgrade_zero == to_upgrade_speed:
        SPEED +=1
        to_upgrade_zero = 0 # restart to count again 10 coins
